...
export default function ListingCard({ listing }: { listing: Listing }) {
  ...
  return (
    <>
      <div className="group flex flex-col bg-gray-900 rounded-2xl shadow-sm border border-gray-800 hover:shadow-md hover:border-gray-700 transition-all overflow-hidden">
        <a
        ...
        {isFacebook && (
          <button
            ...
            className="mx-4 mb-4 px-3 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-medium rounded-lg transition-colors"
          >
            Message Seller
          </button>
        )}
